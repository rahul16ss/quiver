...
| AC-15 | README/docs/pack manifests describe the actual current model, provider, workflow, and capability boundaries; no stale Vertex/old-slug/Electron claims remain in active docs. Historical refactor docs are explicitly bannered. | `README.md`, `docs/*`, `NOTES/FINISH_LINE.md`, `docs/refactor/*` | grep audit + doc checks | [x] reconciled 2026-08-07; keep aligned on further code changes |
