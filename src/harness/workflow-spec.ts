...
const commonChecks: WorkflowAcceptanceCheck[] = [
  {
    id: "context-approved",
    description: "Context and sources approved before execution",
    assert: (r) => r.contextApproved,
  },
  {
    id: "sensitivity-enforced",
    description: "Sensitivity policy enforced",
    assert: (r) => !!r.sensitivityEnforced,
  },
  {
    id: "no-licensed-substitution",
    description: "No substitution of licensed data with open web",
    assert: (r) => !r.licensedSubstitutionAttempted,
  },
  {
    id: "evidence-locators",
    description: "Evidence and source locators present",
    assert: (r) => r.evidenceLocators > 0,
  },
  {
    id: "maker-checker",
    description: "Maker/checker separation",
    assert: (r) => r.makerCheckerSeparated,
  },
  {
    id: "human-approval",
    description: "Human approval before commit",
    assert: (r) => r.humanApprovalBeforeCommit,
  },
  {
    id: "storage-conflict",
    description: "Storage version/conflict behavior checked",
    assert: (r) => r.storageConflictChecked,
  },
  {
    id: "reproducible",
    description: "Reproducible from the run record",
    assert: (r) => r.reproducible,
  },
  {
    id: "unresolved-honest",
    description: "Unresolved items surfaced honestly",
    assert: (r) => Array.isArray(r.unresolvedItems),
  },
];
...
export const TWELVE_WORKFLOW_SPECS: WorkflowSpec[] = [
  {
    ...
    inputs: [
      {
        id: "press-release",
        path: "fixtures/earnings/press-release.md",
        sourceCategory: "filings-ir",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      ...
      sections: ["reported metrics", "consensus deltas", "transcript highlights"],
    },
    ...
    acceptanceChecks: [
      ...commonChecks,
      officeOutputCheck("application/vnd.openxmlformats-officedocument.wordprocessingml.document"),
    ],
  },
  {
    number: 2,
    ...
    inputs: [
      {
        id: "transcript",
        path: "fixtures/transcripts/q2.md",
        sourceCategory: "transcripts-events",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "memo",
      mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
      sections: ["guidance shifts", "tone analysis", "non-GAAP checks"],
    },
    dataSensitivity: "public",
    reviewer: "analyst",
  ...
  },
  {
    number: 3,
    id: "company-primer",
    name: "Company or sector primer",
    family: "research",
    inputs: [
      {
        id: "filings",
        path: "fixtures/primer/10k.md",
        sourceCategory: "filings-ir",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "primer",
      mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
      sections: ["business overview", "financials", "comps"],
    },
    dataSensitivity: "public",
  ...
  },
  {
    ...
    inputs: [
      {
        id: "thesis",
        path: "fixtures/thesis/thesis.xlsx",
        sourceCategory: "portfolio-models-trackers",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      ...
      sections: ["long/short thesis", "KPI catalyst scoring"],
    },
    ...
    acceptanceChecks: [
      ...commonChecks,
      officeOutputCheck("application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"),
      formulaLayoutCheck,
    ],
  },
  {
    ...
    deliverable: {
      type: "memo",
      mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
      sections: ["executive summary", "financial overview", "risks", "open diligence"],
    },
    dataSensitivity: "confidential-internal",
    reviewer: "ic_member",
    noSubstituteCategories: ["market-data-estimates"],
  ...
  {
    number: 6,
    id: "diligence-tracker",
    name: "Diligence tracker",
    family: "dealmaking",
    inputs: [
      {
        id: "vdr",
        path: "fixtures/diligence/vdr.xlsx",
        sourceCategory: "internal-research-notes",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "tracker",
      mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      sections: ["document tracking", "red flag matrix"],
    },
    dataSensitivity: "confidential-internal",
    reviewer: "vp",
    noSubstituteCategories: [],
  ...
  },
  {
    ...
    inputs: [
      {
        id: "landscape",
        path: "fixtures/marketmap/landscape.csv",
        sourceCategory: "public-web-research",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      ...
      sections: ["landscape", "unit economics", "multiples"],
    },
    dataSensitivity: "public",
    reviewer: "principal",
    noSubstituteCategories: ["market-data-estimates"],
  ...
  {
    number: 8,
    id: "pitchbook-materials",
    name: "Pitchbook or transaction materials",
    family: "dealmaking",
    inputs: [
      {
        id: "creds",
        path: "fixtures/pitchbook/creds.md",
        sourceCategory: "internal-research-notes",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "pitchbook",
      mimeType: "application/vnd.openxmlformats-officedocument.presentationml.presentation",
      sections: ["credentials", "transaction overview"],
    },
    dataSensitivity: "confidential-internal",
    reviewer: "partner",
    noSubstituteCategories: ["market-data-estimates"],
  ...
  },
  {
    number: 9,
    id: "portfolio-review",
    name: "Portfolio review pack",
    family: "wealth",
    inputs: [
      {
        id: "holdings",
        path: "fixtures/wealth/holdings.xlsx",
        sourceCategory: "portfolio-models-trackers",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "tracker",
      mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
      sections: ["allocation", "performance", "risk"],
    },
    dataSensitivity: "confidential-internal",
    reviewer: "cio",
    noSubstituteCategories: ["market-data-estimates"],
  ...
  },
  {
    ...
    inputs: [
      {
        id: "client",
        path: "fixtures/wealth/client.md",
        sourceCategory: "internal-research-notes",
        synthetic: true,
      },
    ],
  ...
  {
    number: 11,
    id: "manager-research-note",
    name: "Manager research note",
    family: "wealth",
    inputs: [
      {
        id: "manager",
        path: "fixtures/wealth/manager.md",
        sourceCategory: "internal-research-notes",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "note",
      mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
      sections: ["due diligence", "style drift audit"],
    },
    dataSensitivity: "public",
    reviewer: "analyst",
    noSubstituteCategories: [],
  ...
  {
    number: 12,
    id: "client-commentary",
    name: "Client commentary",
    family: "wealth",
    inputs: [
      {
        id: "market",
        path: "fixtures/wealth/market.md",
        sourceCategory: "public-web-research",
        synthetic: true,
      },
    ],
    ...
    deliverable: {
      type: "commentary",
      mimeType: "application/vnd.openxmlformats-officedocument.wordprocessingml.document",
      sections: ["market update", "positioning"],
    },
    dataSensitivity: "public",
    reviewer: "advisor",
    noSubstituteCategories: ["market-data-estimates"],
...
export function failingRunRecord(
  spec: WorkflowSpec,
  failure: "substitution" | "no-approval" | "wrong-mime" | "no-evidence",
): WorkflowRunRecord {
  const base = passingRunRecord(spec);
  switch (failure) {
    case "substitution":
      return { ...base, licensedSubstitutionAttempted: true };
    case "no-approval":
      return { ...base, humanApprovalBeforeCommit: false };
    case "wrong-mime":
      return { ...base, deliverableMimeType: "text/plain" };
    case "no-evidence":
      return { ...base, evidenceLocators: 0 };
  }
}
