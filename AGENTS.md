...
Repo-local canon:
- `spec-quiver-harness.md` — the product spec. **§19 "Current State & Build
  Order"** is the authoritative status table and the only section allowed to
  change with reality. Build toward the spec in §19's order.
...
5. Commits are signed `Co-Authored-By: Quiver <quiver@users.noreply.github.com>`
