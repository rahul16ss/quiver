...
export async function runHarnessTests(): Promise<number> {
  ...
  // exit codes.
  const files = ["01-interfaces.test.ts", "02-model-client.test.ts", "03-research-gateway.test.ts", "04-goal-contract.test.ts", "05-execution-engine.test.ts", "06-office-engine.test.ts", "07-storage-providers.test.ts", "08-workflow-scenarios.test.ts", "09-security-threats.test.ts", "10-domain-broker.test.ts", "11-experience-plane.test.ts", "12-integration-e2e.test.ts", "13-customer-pack-fixture.test.ts", "14-provider-bridge.test.ts"];
