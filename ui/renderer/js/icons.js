...
const STATUS_ICONS = {
  ...
  verify: '<svg viewBox="0 0 12 12" aria-hidden="true"><path fill="currentColor" d="M4.7 9.2 1.8 6.3l.9-.9 2 2 4.2-4.2.9.9z"/></svg>',
  flagged: '<svg viewBox="0 0 12 12" aria-hidden="true"><path fill="currentColor" d="M2.2 1.5h.9v9H2.2zm1.5 0H9.5L8.2 4.2 9.5 7H3.7z"/></svg>',
  pending: '<svg viewBox="0 0 12 12" aria-hidden="true"><circle cx="6" cy="6" r="1.4" fill="currentColor"/></svg>',
  needs: '<svg viewBox="0 0 12 12" aria-hidden="true"><path fill="currentColor" d="M5.2 8.6h1.6V10H5.2zM6 2a2.6 2.6 0 0 1 2.6 2.6c0 1.2-.7 1.8-1.5 2.4-.5.4-.7.6-.7 1.2H5.2c0-1 .5-1.5 1.2-2 .7-.5 1.2-.9 1.2-1.6A1.4 1.4 0 0 0 6 3.4 1.4 1.4 0 0 0 4.6 4.8H3.2A2.8 2.8 0 0 1 6 2z"/></svg>',
};
